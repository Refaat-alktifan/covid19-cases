        ...
        <!--[if lte IE 9]>
          ...
          <section class="mt-50 mb-50">
            <div class="requirments-section">
              ...
              <?php 
              if ($info['phpversion'] >= 7.2 && $info['mbstring'] == 1 && $info['bcmath'] == 1 && $info['ctype'] == 1 && $info['json'] == 1 && $info['openssl'] == 1 && $info['pdo'] == 1 && $info['tokenizer'] == 1 && $info['xml'] == 1 && $info['fileinfo'] == 1) { ?>
                <a href="{{ route('install.info') }}" class="btn btn-primary install-btn f-right">Next</a>
                <?php
              }else{ ?>
